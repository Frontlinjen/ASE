...
//	}
	...
	public RaavareDTO getRaavare(int raavareId) throws DALException {
		ResultSet rs = DatabaseConnector.doQuery("SELECT * FROM raavare WHERE raavare_id = " + raavareId + ";");
		try{
	...
	public List<RaavareDTO> getRaavareList() throws DALException {
		...
		ResultSet rs = DatabaseConnector.doQuery("SELECT * FROM raavare;");
		try
		{
			while (rs.next()) 
			{
	...
	public int createRaavare(RaavareDTO raavare) throws DALException {
		return DatabaseConnector.doUpdate("INSERT INTO raavare(raavare_id, raavare_navn) VALUES " +
	...
	public int updateRaavare(RaavareDTO raavare) throws DALException {
			return DatabaseConnector.doUpdate("UPDATE raavare SET raavare_navn = '" 
